...
public class DeserializedAvroConsumer {
    private static final Logger logger = LoggerFactory.getLogger(DeserializedAvroConsumer.class);
    ...
    private static Consumer<Long, Employee> createConsumer() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
                "org.prwatech.kafka.deserializers.avro.GenericAvroDeserializer");
